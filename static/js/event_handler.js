document.addEventListener('DOMContentLoaded', domReady);
        ...
        function objectSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = 'resources/self/dlab_high';
                        break;
                    case 1:
                        image.src = 'resources/self/yard_high';
                        break;
                    case 2:
                        image.src = 'resources/self/adc';
                        break;
                    case 3:
                        image.src = 'resources/self/drone';
                        break;
                    case 4:
                        image.src = 'resources/self/polybahn';
                        break;
                    case 5:
                        image.src = 'resources/self/rigi';
                        break;
                    case 6:
                        image.src = 'resources/self/half_bahnhof';
                        break;
                    case 7:
                        image.src = 'resources/self/dlab_spot';
                        break;    
                }
                switch (i) {
                    case 0:
                        image.src = image.src + '/nerfw.png';
                        break;
                    case 1:
                        image.src = image.src + '/robust.png';
                        break;
                    case 2:
        ...
        function ablation3DEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (i) {
                    case 0:
                        image.src = image.src + '_no3d.png';
                        break;
                    case 1:
                        image.src = image.src + '_ours.png';
                        break;
                    case 2:
                        image.src = image.src + '_upgt.png';
                        break;
                    case 3:
